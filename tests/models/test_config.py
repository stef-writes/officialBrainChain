...
def test_llm_config_validation():
    ...
    config = LLMConfig(
        model="gpt-4",
        api_key="sk-12345678901234567890123456789012345678901234567890",
        temperature=0.7,
        max_tokens=1000
    )
    ...
    assert "ensure this value is less than or equal to 1" in str(excinfo.value)
